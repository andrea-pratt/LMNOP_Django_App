    ...
    def test_change_image_for_own_note_expect_old_deleted(self):
        ...
        with self.settings(MEDIA_ROOT=self.MEDIA_ROOT):
            ...
            with open(first_img_file_path, 'rb') as first_img_file:
                ...
                resp = self.client.post(reverse('edit_note', kwargs={'note_pk': 1} ), {'image': first_img_file }, follow=True)
                ...
                with open(second_img_file_path, 'rb') as second_img_file:
                    resp = self.client.post(reverse('edit_note', kwargs={'note_pk':1}), {'image': second_img_file}, follow=True)
